document.getElementById('trelloForm').addEventListener('submit', function(event) {
  ...
  .then(data => {
    ...
    alert('Success! Your request was successfully logged.');
    document.getElementById('trelloForm').reset(); // Reset the form after submission
  })
  .catch(error => {
    console.error('Error creating card:', error);
    alert('There was an error logging your request.');
  });
});